...
public class RealmAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View view, ViewGroup viewGroup) {
        ...
        if (view == null){
            ...
            viewHolder.nombreCompleto = view.findViewById(R.id.nombre);
...
//        viewHolder.apellidos.setText(personas.get(position).getApellidos());
        viewHolder.nombreCompleto.setText(personas.get(position).getNombrecompleto());
    ...
    private void editar(final Persona persona) {
        ...
        final EditText nombreCompleto = viewI.findViewById(R.id.nombre);
...
//        apellidos.setText(persona.getApellidos());
        ...
        builder.setPositiveButton("Guardar", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                String nombreCo = nombreCompleto.getText().toString().trim();
...
//                    persona.setApellidos(apellidosM);
                    persona.setNombrecompleto(nombreCo);
